...
export const ru: Translation = {
	...
	[Key.plan]: "План",
	[Key.planDescription]: "Ежедневные планы и списки задач.",
	[Key.planEmpty]: "На сегодня пока нет плана",
	[Key.planToday]: "План на сегодня",
	[Key.morePlan]: "Больше планов",
	[Key.planProgress]: "Выполнено {done}/{total}",
	[Key.planNoTasks]: "Нет задач",
