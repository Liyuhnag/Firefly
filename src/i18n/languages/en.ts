...
export const en: Translation = {
	...
	[Key.plan]: "Plan",
	[Key.planDescription]: "Daily plans and to-do lists.",
	[Key.planEmpty]: "No plan for today yet",
	[Key.planToday]: "Today's Plan",
	[Key.morePlan]: "More plans",
	[Key.planProgress]: "{done}/{total} done",
	[Key.planNoTasks]: "No tasks listed",
